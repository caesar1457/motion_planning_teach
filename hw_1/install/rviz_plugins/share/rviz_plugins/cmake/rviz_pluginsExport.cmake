...
foreach(_expectedTarget rviz_plugins::rviz_plugins)
...
# Create imported target rviz_plugins::rviz_plugins
add_library(rviz_plugins::rviz_plugins SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/rviz_pluginsExport-*.cmake")
