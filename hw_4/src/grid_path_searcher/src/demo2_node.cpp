...
{
Demo2Node::Demo2Node(const rclcpp::NodeOptions & options)
: rclcpp::Node("demo2_node", options)
{
  // param
  ...
  map_sub_ = create_subscription<sensor_msgs::msg::PointCloud2>(
    "map", 1, std::bind(&Demo2Node::pointcloud_callBack, this, std::placeholders::_1));
  pts_sub_ = create_subscription<nav_msgs::msg::Path>(
    "waypoints", 1,std::bind(&Demo2Node::waypoints_callback, this, std::placeholders::_1));
...
void Demo2Node::waypoints_callback(const nav_msgs::msg::Path::SharedPtr msg){
...
void Demo2Node::pointcloud_callBack(const sensor_msgs::msg::PointCloud2::SharedPtr msg){
    if(_has_map) return;
...
void Demo2Node::vis_traLibrary(TrajectoryStatePtr *** tralibrary)
{
...
void Demo2Node::trajectory_library(const Eigen::Vector3d start_pt, const Eigen::Vector3d start_velocity, const Eigen::Vector3d target_pt)
{
